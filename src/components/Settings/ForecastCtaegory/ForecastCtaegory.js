...
import * as classes from "./ForecastCategory.module.css";
const EditableContext = React.createContext(null);

const ForecastCtaegory = () => {
  ...
  const handleAdd = async () => {
    setAddLoading(true);
    try {
      const { data } = await axios.post("/forecasthealthcheckcategory", {
        name: `Name  *`,
    ...
    try {
      ...
      if (data?.success) {
        notification.success({
          ...
          message: "forecast category added ",
        });
        getforecastCategory();
      }
    } catch (error) {
  ...
  const handleDelete = async (key) => {
    ...
    try {
      ...
      if (data?.success) {
        notification.success({
          placement: "bottomRight",
          message: "Forecast category deleted",
        });
        getforecastCategory();
      }
...
export default ForecastCtaegory;
